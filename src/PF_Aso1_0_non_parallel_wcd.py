...
def decompose_θ(θ):
    ...
    return λ, η, b11, b22, As11, As12, As13, As21, As22, As23, As31, As32, As33, Bs11, Bs22, Bs33
...
def update_θ(H):
    ...
    while Ass_stable == False:
        ...
        Ass = np.array([[β_s1[0,0], β_s1[1,0], β_s1[2,0]],\
                        [β_s2[0,0], β_s2[1,0], β_s2[2,0]],\
...
def init_H(Λ_scale, cd_scale):
    ...
    H0 = {'1st':[np.array([[1], [1]]), np.eye(2) * Λ_scale, 1 * cd_scale, 1 * cd_scale], 
          ...
          '4th':[np.array([[0], [0], [0]]), np.eye(3) * Λ_scale, 1 * cd_scale, 1 * cd_scale],
...
def init_X(θ, D_0):
    ...
    λ, η, b11, b22, As11, As12, As13, As21, As22, As23, As31, As32, As33, Bs11, Bs22, Bs33 = decompose_θ(θ)
    ones = np.ones([3,1])
...
def update_H(Xt_next, Xt, Ht):
    ...
    bayes_para_update(Ht['4th'][0], Ht['4th'][1], Ht['4th'][2], Ht['4th'][3], np.array([[St1],[St2],[St3]]), St_next_2)
